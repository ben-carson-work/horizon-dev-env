...
<jsp:include page="eventlist-css.jsp" />
<jsp:include page="eventlist-js.jsp" />

<div id="eventlist"  class="status-select">
	<%-- HEADER --%>
	<div class="toolbar">
		<div id="adm-title" class="title wrap">Event List</div>
		<%-- Back BUTTON --%>
	...
	<div class="body">
		...
		<div class="wrap srolling">
			<div class="body-panel scrolling">
				<ul class="ios-list" id="ULeventlist">
				  </ul>
			</div>
		</div>
	</div>
	<div id="alertmsgbg" style="display:none;">
		<div id="alertmsg">
			...
			<div id="alertmsgHeader">Create Performance?</div>
			<div id="alertmsgBody">
