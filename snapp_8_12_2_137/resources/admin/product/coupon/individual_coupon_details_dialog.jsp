...
<v:dialog id="individual_coupon_details_dialog" icon="coupon.png" tabsView="true" title="Individual Coupon" width="950" height="650" autofocus="false">

<v:tab-group name="tab" main="true">
  <v:tab-item-embedded tab="tabs-main" caption="@Common.Profile" icon="profile.png" default="true">
    <jsp:include page="individual_coupon_details_dialog_tab_main.jsp"/>
  </v:tab-item-embedded>
  <v:tab-item-embedded tab="tabs-transaction" caption="@Common.Transaction" icon="transaction.png">
    <jsp:include page="individual_coupon_details_dialog_tab_transaction.jsp"/>
  </v:tab-item-embedded>
...
$(document).ready(function() {
  var dlg = $("#individual_coupon_details_dialog");
