...
<b><v:itl key="<%=LkSNLedgerRegDateTimeRule.ScheduledDateTime.getHtmlDescription(pageBase.getLang())%>"/></b>: Ledger is registered on amortization date<br/>
...
<i>Amortization scheduled on July 7th</i><br/>
