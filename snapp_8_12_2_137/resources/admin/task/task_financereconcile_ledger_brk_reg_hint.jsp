...
<b><v:itl key="<%=LkSNLedgerRegDateTimeRule.ScheduledDateTime.getHtmlDescription(pageBase.getLang())%>"/></b>: Ledger is registered on breakage date<br/>
...
<i>Breakage scheduled on July 7th</i><br/>
