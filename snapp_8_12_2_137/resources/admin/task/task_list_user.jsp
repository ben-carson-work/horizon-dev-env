...
<div class="tab-toolbar">
  <div class="btn-group">
    <v:button id="new-btn" caption="@Common.New" fa="plus" dropdown="true" bindGrid="task-grid" bindGridEmpty="true"/>
		...
		<% for (TaskBase<?> instance : BOTaskManager.getInstances(LkSNTaskType.GenericOperationalTask)) { %>
...
<div class="tab-content">
  <% String params = "TaskType=" + LkSNTaskType.GenericOperationalTask.getCode(); %>
