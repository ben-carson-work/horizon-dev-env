...
<v:alert-box type="info"><v:itl key="@Task.LedgerRecover_Description"/></v:alert-box>

<v:widget caption="Configuration">
  <v:widget-block>
    <v:form-field caption="@Task.LedgerRecover_BaseDate" hint="@Task.LedgerRecover_BaseDate_Hint">
