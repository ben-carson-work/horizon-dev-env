...
<v:widget caption="@Common.Configuration">
	<v:widget-block>
	  <v:form-field caption="@Task.CryptoMaintenance_PersistenceDays" hint="@Task.CryptoMaintenance_PersistenceDaysHint"><v:input-text field="cfg.PersistanceDays" placeholder="90"/></v:form-field>
	</v:widget-block>
</v:widget>
...
function saveTaskConfig(reqDO) {
  var days = parseInt($("#cfg\\.PersistanceDays").val());
  if (!isNaN(days)) {
	  var config ={
			  PersistanceDays: days
		}
