...
<jsp:useBean id="pageBase" class="com.vgs.snapp.web.bko.page.PageBO_StatsSalesByProduct" scope="request"/>
...
<script>
  ...
  function doApply() {
    setGridUrlParam("#sales-by-product-data", "DateFrom", $("#DateFrom-picker").getXMLDate());
    setGridUrlParam("#sales-by-product-data", "DateTo", $("#DateTo-picker").getXMLDate());
    setGridUrlParam("#sales-by-product-data", "LocationId", getStringParam("#LocationId"));
    setGridUrlParam("#sales-by-product-data", "OpAreaId", getStringParam("#OpAreaId"));
    setGridUrlParam("#sales-by-product-data", "WorkstationId", getStringParam("#WorkstationId"));
    setGridUrlParam("#sales-by-product-data", "SaleChannelId", getStringParam("#SaleChannelId"));
    setGridUrlParam("#sales-by-attribute-data", "TagIDs", ($("#TagIDs").val() || ""));
    
    changeGridPage("#sales-by-product-data", "first");
  }
</script>
...
<v:tab-group name="tab" main="true">
  <v:tab-item-embedded tab="tabs-dashboard" caption="@Common.Dashboard" default="true">
    <form id="filter-form" action="<%=pageBase.getContextURL()%>?page=stats_sales_by_product" method="post">
      ...
      <div class="profile-cont-div">
        ...
        <v:async-grid id="sales-by-product-data" jsp="stats/stats_sales_by_product_data.jsp" params="<%=params%>"/>
      </div>
    </div>
  </v:tab-item-embedded>
</v:tab-group>  
