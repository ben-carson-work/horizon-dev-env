...
QueryDef qdef = new QueryDef(QryBO_PaymentToken.class)
		.addSelect(QryBO_PaymentToken.Sel.PaymentTokenId)
		.addSelect(QryBO_PaymentToken.Sel.PaymentTokenDesc)
		.addSelect(QryBO_PaymentToken.Sel.CardType)
		.addSelect(QryBO_PaymentToken.Sel.CardNumber)
		.addSelect(QryBO_PaymentToken.Sel.CardExpDate)
		.addSelect(QryBO_PaymentToken.Sel.CardHolderName)
		.addSelect(QryBO_PaymentToken.Sel.CreateDate)
		.addSelect(QryBO_PaymentToken.Sel.ExpirationDate)
		.addFilter(QryBO_PaymentToken.Fil.PaymentTokenType, LkSNPaymentTokenType.PayByToken.getCode())
	  .addSort(QryBO_PaymentToken.Sel.CreateDate);
...
<v:grid dataset="<%=ds%>" qdef="<%=qdef%>" id="credit-card-grid" entityType="<%=LkSNEntityType.PaymentToken%>">
  <thead>
  <tr class="header">
    <tr>
      <td></td>
