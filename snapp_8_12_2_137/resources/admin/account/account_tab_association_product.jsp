...
<div class="tab-toolbar">
  <% String hRefAdd="javascript:showSearchDialog(" + LkSNEntityType.ProductType.getCode() + ")";%>
  <v:button caption="@Common.Add" title="@Account.AddProduct2Association" fa="plus" href="<%=hRefAdd%>" enabled="<%=canEdit%>"/>

  <% String hRefRemove="javascript:deleteProducts()";%>
  <v:button caption="@Common.Remove" fa="minus" title="@Account.RemoveProductsFromAssociation" href="<%=hRefRemove%>" enabled="<%=canEdit%>"/>
...
<div class="tab-content">    
  ...
  <% String params = "AssociationId=" + pageBase.getId() + "&ProductType=" + LkSNProductType.Product.getCode(); %>
