...
//Where
reqDO.PortfolioId.setString(pageBase.getId());
...
String unbindedSlotLogsOnly = pageBase.getNullParameter("UnbindedSlotLogsOnly");
if (unbindedSlotLogsOnly != null)
  reqDO.UnbindedSlotLogsOnly.setBoolean(true);

String bindedSlotLogsOnly = pageBase.getNullParameter("BindedSlotLogsOnly");
if (bindedSlotLogsOnly != null)
...
<v:dialog id="portfolio-ledger-dialog" icon="transaction.png" title="@Common.Transactions" width="1000" height="500">
