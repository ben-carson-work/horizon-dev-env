FUNCTION [dbo].[fnDecrypt] 
/*
 * Decrypts a barcode portion encrypted through dbo.fnEncrypt() function.
 */
(
  @value varchar(max), -- Encrypted string to be decrypted
...
BEGIN
  ...
  declare @seedStr varchar(max) = Cast(@seed as varchar(max));
  declare @salt int = 57;
