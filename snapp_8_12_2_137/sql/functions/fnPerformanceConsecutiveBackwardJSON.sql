FUNCTION [dbo].[fnPerformanceConsecutiveBackwardJSON]
/*
 * Returns a JSON (mapped to com.vgs.snapp.dataobject.DOPerformanceConsecutive) with performance's consecutive performances (returning the N previous performances)
 */
(
